    ...
    return (
        <>
            <div className='bg-[#E5E7EB]'>
                <div className='px-[104px] py-[87px] xl:py-[4.531vw] xl:px-[5.417vw] '>
                    <section>
                            ...
                            {props.data1.map((elm, index) => {
                                return (
                                    <div className='col-span-12 md:col-span-6 xl:col-span-4' >
                                        <div className="bg-[#fff] rounded-lg relative h-[226px] shadow-lg">
                                            <div className="flex justify-end xl:gap-[1.25vw] gap-[16px] h-full">
                                                <div className="container-img absolute left-0">
                                                    <Image src={`/assets/images/${elm.acadamicImg}`} width={139} height={140} alt="department" />
                                                </div>
                ...
                <div className=' rounded-[24px] xl:rounded-[1.250vw] m-[24px]'>
                    ...
                    {activeIndex == 1 ?
                        <div className='col-span-7 p-[16px] xl:p-[0.833vw]'>
                              {activeIndexdata.map((elementss,ind)=>{
                                return(
                                    <div>
                                         <div className='text-[#374151] text-[24px] xl:text[1.250vw] font-bold '>{elementss.name}</div>
                        ...
                        <div className='col-span-5 pl-[16px] xl:pl-[0.833vw]'>
                            ...
                            {acadamicPopupData.map((element, ind) => {
                                return (
                                    <div>
                                        <div  className='bg-[#F5F6F7] font-medium rounded-[8px]  py-[13px] px-[16px] my-[8px] xl:py-[0.677vw] xl:px-[0.833vw] xl:rounded-[0.417vw]'>
                                            <div className='text-[#374151] font-medium text-[18px] xl:text-[0.938vw]'>{element.description}</div>
                                        </div>
                                    </div>
                            ...
                            <div className='p-[16px] rounded-[8px] border border-[#BECDE3] xl:p-[0.833vw] xl:rounded-[0.417vw]'>
