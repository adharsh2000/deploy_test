    ...
    <div className='logoutredirect' style={{ backgroundColor: '#e5e7eb', display: 'flex', flexDirection: 'column',alignItems: 'center', height: '100vh'}}>
      <div className='Errormessage'>
        <div className='grid px-96 text-center mt-10'>
          <Image className='mx-auto' height={150} width={150} src={"/assets/images/logo.svg"}></Image>
      ...
      <div className="Signoutbtn bg-[]" style={{ cursor: 'pointer', marginLeft: 'auto', marginRight: 'auto', textDecoration: 'underline'}} onClick={Logout}>Go to Login page</div>
    </div>
  )
}
