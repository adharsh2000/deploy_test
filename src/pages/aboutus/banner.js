        ...
        <div className='xl:max-w-[88.3025vw] mx-auto xl:px-[0] px-[20px]'>
            <div className="about-banner-info md:w-[60%] xl:w-[40%] relative z-[1]">
              ...
              <div className="w-full ">
                  ...
                  <Link href="/aboutus/acadamics" className="inline-flex items-center gap-2 bg-[#A93439] hover:bg-[#762428] rounded-[8px] xl:rounded-[0.417vw] py-[8px] xl:py-[0.730vw] px-[14px] xl:px-[1.04vw] text-[16px] xl:text-[0.94vw] text-white mt-[20px] xl:mt-[1.56vw] ease-linear duration-200">
                    Find your Future
